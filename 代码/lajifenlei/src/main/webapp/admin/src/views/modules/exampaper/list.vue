        ...
        <div v-if="showFlag">
            <el-form :inline="true" :model="searchForm" class="form-content">
                <el-row :gutter="20" class="slt" :style="{justifyContent:contents.searchBoxPosition=='1'?'flex-start':contents.searchBoxPosition=='2'?'center':'flex-end'}">
                     ...
                     <el-form-item :label="contents.inputTitle == 1 ? '知识问答试卷名称' : ''">
                         <el-input prefix-icon="el-icon-search" v-model="searchForm.exampaperName" placeholder="知识问答试卷名称" clearable></el-input>
                     </el-form-item>
                         
                     <el-form-item :label="contents.inputTitle == 1 ? '知识问答试卷状态' : ''">
                        <el-select v-model="searchForm.exampaperTypes" placeholder="请选择知识问答试卷状态">
                ...
                <el-row class="ad" :style="{justifyContent:contents.btnAdAllBoxPosition=='1'?'flex-start':contents.btnAdAllBoxPosition=='2'?'center':'flex-end'}">
                    <el-form-item>
                        ...
                        <a style="text-decoration:none" class="el-button el-button--success"
                           ...
                           href="http://localhost:8080/lajifenlei/upload/exampaperMuBan.xls"
                        >批量导入知识问答试卷表数据模板</a>
                        &nbsp;
                        <el-upload
                                v-if="isAuth('exampaper','导入导出')"
...
<script>
    ...
    //当前表下拉框搜索条件
            ...
            json_fields: {
                //级联表字段
                //本表字段
                     '知识问答试卷名称': "exampaperName",
                     '测试时长(分钟)': "exampaperDate",
                     '知识问答试卷总分数': "exampaperMyscore",
                     '知识问答试卷状态': "exampaperTypes",
            },
