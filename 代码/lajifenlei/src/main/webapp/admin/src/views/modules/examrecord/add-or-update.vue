    ...
    <div class="addEdit-block">
        ...
        >
            <el-row>
                ...
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="知识问答试卷表" prop="exampaperId">
                        <el-select v-model="ruleForm.exampaperId" placeholder="请选择知识问答试卷表" @change="exampaperChange">
                            <el-option
                ...
                <el-col :span="12">
                    <el-form-item class="input" v-if="type!='info'"  label="知识问答试卷名称" prop="exampaperName">
                        <el-input v-model="exampaperForm.exampaperName"
                                  placeholder="知识问答试卷名称" clearable  :readonly="ro.exampaperName" readonly></el-input>
                    </el-form-item>
                    <div v-else>
                ...
                <el-col :span="12">
                    <el-form-item class="input" v-if="type!='info'"  label="知识问答试卷总分数" prop="exampaperMyscore">
                        <el-input v-model="exampaperForm.exampaperMyscore"
                                  placeholder="知识问答试卷总分数" clearable  :readonly="ro.exampaperMyscore" readonly></el-input>
                    </el-form-item>
                    <div v-else>
        ...
        data() {
            ...
            return {
                ...
                rules: {
                    ...
                    exampaperId: [
                        { required: true, message: '所属知识问答试卷id（外键）不能为空', trigger: 'blur' },
                    ],
                    totalScore: [
