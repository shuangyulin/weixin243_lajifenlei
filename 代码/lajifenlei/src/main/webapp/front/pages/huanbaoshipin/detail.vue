...
<mescroll-uni @init="mescrollInit" :up="upOption" :down="downOption" @down="downCallback" @up="upCallback"
		...
		<view class="container">
			...
			<!-- 名字-->
						<view :style='{"textAlign":"left","fontSize":"45upx","color":"black"}'>{{detail.huanbaoshipinName}}
						</view>
				</view>
   	 <view style="margin-top: 10rpx;"></view>
					...
					<view class="detail-list-item"
						...
						<view class="text" :style='{"color":"#6a4826","textAlign":"center","fontSize":"24rpx"}'>
                            {{detail.huanbaoshipinValue}}</view>
					</view>
...
<!-- 视频 -->
			<view style="text-align: center;padding: 20upx;box-sizing: border-box;background: #FFFFFF;"
				...
				<view class="uni-padding-wrap uni-common-mt">
					<view>
						<video id="myVideo" style="preload:auto" muted :src="detail.huanbaoshipinVideo" controls></video>
					</view>
				</view>
			</view>
			<view class="time-content"
				...
				<view class="content" style="line-height: 50upx;letter-spacing: 5upx;"
					...
					<rich-text :nodes="detail.huanbaoshipinContent"></rich-text>
				</view>
			</view>
...
<script>
	export default {
		...
		methods: {
			...
			// 获取详情
			async init() {
				let res = await this.$api.info('huanbaoshipin', this.id);
				this.detail = res.data;
				// 主图
				this.swiperList = this.detail.huanbaoshipinPhoto ? this.detail.huanbaoshipinPhoto.split(",") : [];
			},
